...
const file_clh_msg_proto_rawDesc = "" +
	...
	"\n" +
	"event_time\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\teventTime\"\xe0\x02\n" +
	...
	"\rserver_status\x18\x04 \x01(\v2(.clh_proto.plugin.ClhServerStatusChangedH\x00R\fserverStatus\x129\n" +
	...
	"(CLH_PLUGIN_LIFECYCLE_EVENT_TYPE_REPLACED\x10\x04BJZ,github.com/sydneyowl/clh-proto/gen/go/plugin\xaa\x02\x19SydneyOwl.CLHProto.Pluginb\x06proto3"
...
var file_clh_msg_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_clh_msg_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_clh_msg_proto_goTypes = []any{
	...
	(*ClhPluginLifecycleChanged)(nil), // 3: clh_proto.plugin.ClhPluginLifecycleChanged
	(*ClhServerStatusChanged)(nil),    // 4: clh_proto.plugin.ClhServerStatusChanged
	(*ClhInternalMessage)(nil),        // 5: clh_proto.plugin.ClhInternalMessage
	nil,                               // 6: clh_proto.plugin.ClhQSOUploadStatusChanged.UploadedServicesEntry
	nil,                               // 7: clh_proto.plugin.ClhQSOUploadStatusChanged.UploadedServicesErrorMessageEntry
	(*timestamppb.Timestamp)(nil),     // 8: google.protobuf.Timestamp
}
var file_clh_msg_proto_depIdxs = []int32{
	6,  // 0: clh_proto.plugin.ClhQSOUploadStatusChanged.uploaded_services:type_name -> clh_proto.plugin.ClhQSOUploadStatusChanged.UploadedServicesEntry
	7,  // 1: clh_proto.plugin.ClhQSOUploadStatusChanged.uploaded_services_error_message:type_name -> clh_proto.plugin.ClhQSOUploadStatusChanged.UploadedServicesErrorMessageEntry
	8,  // 2: clh_proto.plugin.ClhQSOUploadStatusChanged.date_time_off:type_name -> google.protobuf.Timestamp
	8,  // 3: clh_proto.plugin.ClhQSOUploadStatusChanged.date_time_on:type_name -> google.protobuf.Timestamp
	...
	8,  // 6: clh_proto.plugin.ClhPluginLifecycleChanged.event_time:type_name -> google.protobuf.Timestamp
	8,  // 7: clh_proto.plugin.ClhServerStatusChanged.event_time:type_name -> google.protobuf.Timestamp
	2,  // 8: clh_proto.plugin.ClhInternalMessage.qso_upload_status:type_name -> clh_proto.plugin.ClhQSOUploadStatusChanged
	3,  // 9: clh_proto.plugin.ClhInternalMessage.plugin_lifecycle:type_name -> clh_proto.plugin.ClhPluginLifecycleChanged
	4,  // 10: clh_proto.plugin.ClhInternalMessage.server_status:type_name -> clh_proto.plugin.ClhServerStatusChanged
	8,  // 11: clh_proto.plugin.ClhInternalMessage.timestamp:type_name -> google.protobuf.Timestamp
...
func file_clh_msg_proto_init() {
	...
	file_clh_msg_proto_msgTypes[3].OneofWrappers = []any{
